...
def main():
    ...
    bangdiem = DANHGIA()
    bangdiem.load_dulieu("D:/DOCUMENTS/Me/Code/diem_chitiet.txt")
    a = bangdiem.tinhdiem_trungbinh()   
    print("Điểm trung bình từng học sinh : ", a)
    bangdiem.luudiem_trungbinh("D:/DOCUMENTS/Me/Code/interview/output.txt")
    print("Xếp loại từng học sinh : ",bangdiem.xeploai_hocsinh())
    print("Xếp loại thi đại học : ",bangdiem.xeploai_thidaihoc_hocsinh())
    print(" ")

    tunhien2 = TUNHIEN()
    tunhien2.load_dulieu("D:/DOCUMENTS/Me/Code/diem_chitiet.txt")
    ...
    xahoi2 = XAHOI()
    xahoi2.load_dulieu("D:/DOCUMENTS/Me/Code/diem_chitiet.txt")
    ...
    coban2 = COBAN()
    coban2.load_dulieu("D:/DOCUMENTS/Me/Code/diem_chitiet.txt")
